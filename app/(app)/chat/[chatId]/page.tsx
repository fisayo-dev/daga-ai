      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="flex-1 overflow-y-auto bg-transparent px-6 py-6 space-y-6">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex justify-end">
              <div className="bg-primary/35 text-black dark:bg-foreground/35 dark:text-foreground rounded-2xl rounded-tr-sm px-4 py-3 max-w-[80%]">
        ...
        <div className="px-4 md:px-6 pb-6 ">
          <div className="max-w-3xl mx-auto">
            <div className="rounded-xl p-3 border border-primary bg-transparent backdrop-blur-xl shadow-lg">
